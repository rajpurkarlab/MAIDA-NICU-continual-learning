...
from utils.constants import COCO_LABELS, COCO_LABELS_INVERSE
...
class CocoDataset(Dataset):
    ...
    def __init__(self, root_dir, set_name="train2017", transform=None):
        ...
        self.coco = COCO(os.path.join(self.root_dir, "annotations.json"))
    ...
    def load_image(self, image_index):
        ...
        path = os.path.join(
            self.root_dir, "images", self.set_name, image_info["file_name"]
        )
