...
For each image the script:
  ...
  3. Resizes so the larger dimension is 640px, preserving aspect ratio.
  4. Pads the shorter dimension with black borders to make a square 640x640 image.
  5. Duplicates the grayscale channel into 3-channel RGB for model compatibility.

Bounding boxes are transformed into the 640x640 coordinate space (scale plus
padding offset), and pixel-spacing values are rescaled to match the new image size.
"""
