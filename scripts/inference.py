"""
Run inference with a CarinaNet model on hospital datasets.

Loads a (pretrained or fine-tuned) model and runs landmark prediction over the
train and test splits of the configured hospital data, saving predictions for
each split.
"""
