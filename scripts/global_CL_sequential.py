"""
Entry point for standard continual learning runs.

Loads a config, configures optional Weights & Biases logging, and runs continual
learning sequentially over all hospitals via continual_learning.main(). Supports
running with pretrained or randomly initialized weights.
"""
