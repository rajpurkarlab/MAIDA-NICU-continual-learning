...
Utilities for loading predictions from:
...
CL_LOCATIONS = {
    ...
    'LOCATION_2': {
        ...
        'hospitals': [
            'Sidra-Health', 'Tel-Aviv-Medical-Center',
...
def load_direct_predictions(
    ...
    def get_actual_hospital(file_name: str) -> str:
        """Map a prediction file name to its hospital, handling the special
        per-patient filename prefixes used for Essen, Osaka, and Chiang Mai."""
...
def get_hospital_display_name(normalized_name: str) -> str:
    ...
    """
    # Returns the normalized name unchanged; extend with a mapping if a
    # different display format is required.
